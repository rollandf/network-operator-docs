...
api-docs: #gen-crd-api-docs
	docker run --rm --volume "`pwd`:/data:Z" pandoc/minimal -f html -t rst --lua-filter=/data/hack/ref_links.lua --columns 200 /data/build/_output/crds-api.html -o /data/docs/customizations/crds.rst
